        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6" style="line-height: 35px;">
                        {{ \Carbon\Carbon::parse($compra->fecha_entrega)->format('d/m/Y') }}
                    </div>
                </div>
    ...
    <div class="col-md-8">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-12">
                        <form name="cambiarEstado" action="{{ route('compras.cambiarEstadoPost') }}" method="POST">
                            ...
                            <div class="form-group d-inline-block">
                                ...
                                <select name="estado" id="estado" class="form-control d-inline-block" required>
                                    ...
                                    @foreach($estados as $estado)
                                        <option value="{{ $estado->id }}"{{ ($estado->id == $compra->estados->first()->id ? 'disabled' : '') }}>{{ $estado->estado }}</option>
                                    @endforeach
                                </select>
                            </div>
                ...
                <div class="row">
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            @foreach($compra->estados as $estado)
                                <tr>
