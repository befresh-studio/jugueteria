...
<div class="row justify-content-center">
    <div class="col-md-8">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('estado-compras.update', $estado_compra->id) }}" method="post">
                    @csrf
                    @method("PUT")
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="text" class="form-control @error('estado') is-invalid @enderror" id="estado" name="estado" value="{{ $estado_compra->estado }}">
