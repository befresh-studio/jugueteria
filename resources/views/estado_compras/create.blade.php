        ...
        <div class="card">
            <div class="card-header">
                <div class="float-start">
                    {{ __('Insertar nuevo estado de compra') }}
                </div>
                <div class="float-end">
            ...
            <div class="card-body">
                <form action="{{ route('estado-compras.store') }}" method="post">
                    @csrf
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="color" class="form-control form-control-color @error('color') is-invalid @enderror" id="color" name="color" value="{{ (old('color') ? old('color') : '#CCCCCC') }}" title="{{ __('Elige un color') }}">
                            @if ($errors->has('color'))
                    ...
                    <div class="mb-3 row">
                        <input type="submit" class="col-md-3 offset-md-5 btn btn-primary" value="{{ __('Insertar estado compra') }}">
                    </div>
