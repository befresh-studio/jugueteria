        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('proveedores.store') }}" method="post">
                        ...
                        <div class="col-md-6">
                            <select class="form-control @error('juguetes') is-invalid @enderror" id="juguetes" name="juguetes[]" multiple>
                                ...
                                @foreach($juguetes as $juguete)
                                    <option value="{{ $juguete->id }}"{{ (old('juguetes') && in_array($juguete->id, old('juguetes')) ? ' selected' : '') }}>{{ $juguete->nombre }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="mb-3 row">
                        <input type="submit" class="col-md-3 offset-md-5 btn btn-primary" value="{{ __('Insertar proveedor') }}">
                    </div>
